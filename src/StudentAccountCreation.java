...
public class StudentAccountCreation extends javax.swing.JFrame {
    ...
    private void registerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerBtnActionPerformed
        ...
        password = passEdit.getPassword().toString();
        confirmPassword = confirmPassEdit.getPassword().toString();
    ...
    private void sendToDatabase(String username, String email, String phone, String gender, String password) {
        try {
            ...
            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hostel_information_tracker", "root", "")) {
